...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="/static/admins/assets/css/font-awesome.min.css" />
        <!--[if IE 7]>
          <link rel="stylesheet" href="/static/admins/assets/css/font-awesome-ie7.min.css" />
        <![endif]-->
        <link rel="stylesheet" href="/static/admins/assets/css/ace.min.css" />
        <link rel="stylesheet" href="/static/admins/assets/css/ace-rtl.min.css" />
        <link rel="stylesheet" href="/static/admins/assets/css/ace-skins.min.css" />
        <link rel="stylesheet" href="/static/admins/css/style.css"/>
        <!--[if lte IE 8]>
          <link rel="stylesheet" href="/static/admins/assets/css/ace-ie.min.css" />
        <![endif]-->
        <script src="/static/admins/assets/js/ace-extra.min.js"></script>
        <!--[if lt IE 9]>
        <script src="/static/admins/assets/js/html5shiv.js"></script>
        <script src="/static/admins/assets/js/respond.min.js"></script>
        <![endif]-->
        <!--[if !IE]> -->
        <script src="/static/admins/js/jquery-1.9.1.min.js"></script>        
        <!-- <![endif]-->
        <!--[if IE]>
         <script type="text/javascript">window.jQuery || document.write("<script src='/static/admins/assets/js/jquery-1.10.2.min.js'>"+"<"+"script>");</script>
        <![endif]-->
        <script type="text/javascript">
            if("ontouchend" in document) document.write("<script src='/static/admins/assets/js/jquery.mobile.custom.min.js'>"+"<"+"script>");
        </script>
        <script src="/static/admins/assets/js/bootstrap.min.js"></script>
        <script src="/static/admins/assets/js/typeahead-bs2.min.js"></script>
        <!--[if lte IE 8]>
          <script src="/static/admins/assets/js/excanvas.min.js"></script>
        <![endif]-->
        <script src="/static/admins/assets/js/ace-elements.min.js"></script>
        <script src="/static/admins/assets/js/ace.min.js"></script>
        <script src="/static/admins/assets/layer/layer.js" type="text/javascript"></script>
        <script src="/static/admins/assets/laydate/laydate.js" type="text/javascript"></script>
        <script src="/static/admins/js/jquery.nicescroll.js" type="text/javascript"></script>
            ...
            <div class="navbar-container" id="navbar-container">
                <div class="navbar-header pull-left">
                    <a href="https://item.taobao.com/item.htm?id=539837098284" class="navbar-brand">
                        <small>                 
                        <img src="/static/admins/images/logo.png" width="470px">
                        </small>
                    </a><!-- /.brand -->
                </div><!-- /.navbar-header -->
